...
distance = 0.01
area_multivariate = 9999.9610319184358
...
def null_deblend(image2):
    ...
    moment_matrix = skimage.measure.moments_central(image2, moment_matrix[0][1]/zeroth_moment, moment_matrix[1][0]/zeroth_moment)
